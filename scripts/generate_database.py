...
# Specify the path to the DuckDB file
db_filename = 'aether_energy_analytics.duckdb'
db_path = f"../{db_filename}"  # Go up one directory to ./code/ and then specify the db_filename
